...
const file_laptop_message_proto_rawDesc = "" +
	"\n" +
	"\x14laptop_message.proto\x12\vgrpc.pcbook\x1a\x17processor_message.proto\x1a\x14memory_message.proto\x1a\x16keyboard_message.proto\x1a\x15storage_message.proto\x1a\x14screen_message.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x87\x04\n" +
	"\x06Laptop\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05brand\x18\x02 \x01(\tR\x05brand\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\"\n" +
	"\x03cpu\x18\x04 \x01(\v2\x10.grpc.pcbook.CPUR\x03cpu\x12+\n" +
	"\x06memory\x18\x05 \x01(\v2\x13.grpc.pcbook.MemoryR\x06memory\x12$\n" +
	"\x04gpus\x18\x06 \x03(\v2\x10.grpc.pcbook.GPUR\x04gpus\x120\n" +
	"\bstorages\x18\a \x03(\v2\x14.grpc.pcbook.StorageR\bstorages\x12+\n" +
	"\x06screen\x18\b \x01(\v2\x13.grpc.pcbook.ScreenR\x06screen\x121\n" +
	"\bkeyboard\x18\t \x01(\v2\x15.grpc.pcbook.KeyboardR\bkeyboard\x12\x1d\n" +
	"\tweight_kg\x18\n" +
	...
	"\x06weightB:\n" +
	"\x1fcom.gitlab.techschool.pcbook.pbP\x01Z\x15pcbook/gRPC_GoLang/pbb\x06proto3"
...
var file_laptop_message_proto_goTypes = []any{
	(*Laptop)(nil),                // 0: grpc.pcbook.Laptop
	(*CPU)(nil),                   // 1: grpc.pcbook.CPU
	(*Memory)(nil),                // 2: grpc.pcbook.Memory
	(*GPU)(nil),                   // 3: grpc.pcbook.GPU
	(*Storage)(nil),               // 4: grpc.pcbook.Storage
	(*Screen)(nil),                // 5: grpc.pcbook.Screen
	(*Keyboard)(nil),              // 6: grpc.pcbook.Keyboard
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: grpc.pcbook.Laptop.cpu:type_name -> grpc.pcbook.CPU
	2, // 1: grpc.pcbook.Laptop.memory:type_name -> grpc.pcbook.Memory
	3, // 2: grpc.pcbook.Laptop.gpus:type_name -> grpc.pcbook.GPU
	4, // 3: grpc.pcbook.Laptop.storages:type_name -> grpc.pcbook.Storage
	5, // 4: grpc.pcbook.Laptop.screen:type_name -> grpc.pcbook.Screen
	6, // 5: grpc.pcbook.Laptop.keyboard:type_name -> grpc.pcbook.Keyboard
	7, // 6: grpc.pcbook.Laptop.updated_at:type_name -> google.protobuf.Timestamp
