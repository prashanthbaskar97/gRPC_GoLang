...
const (
	Storage_UNKWOWN Storage_Driver = 0
...
const file_storage_message_proto_rawDesc = "" +
	"\n" +
	"\x15storage_message.proto\x12\vgrpc.pcbook\x1a\x14memory_message.proto\"\x94\x01\n" +
	"\aStorage\x123\n" +
	"\x06driver\x18\x01 \x01(\x0e2\x1b.grpc.pcbook.Storage.DriverR\x06driver\x12+\n" +
	"\x06memory\x18\x02 \x01(\v2\x13.grpc.pcbook.MemoryR\x06memory\"'\n" +
	"\x06Driver\x12\v\n" +
	"\aUNKWOWN\x10\x00\x12\a\n" +
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: grpc.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: grpc.pcbook.Storage
	(*Memory)(nil),      // 2: grpc.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: grpc.pcbook.Storage.driver:type_name -> grpc.pcbook.Storage.Driver
	2, // 1: grpc.pcbook.Storage.memory:type_name -> grpc.pcbook.Memory
