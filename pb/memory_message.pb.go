...
type Memory struct {
	...
	Unit          Memory_Unit            `protobuf:"varint,2,opt,name=unit,proto3,enum=grpc.pcbook.Memory_Unit" json:"unit,omitempty"`
...
const file_memory_message_proto_rawDesc = "" +
	"\n" +
	"\x14memory_message.proto\x12\vgrpc.pcbook\"\xac\x01\n" +
	"\x06Memory\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x04R\x05value\x12,\n" +
	"\x04unit\x18\x02 \x01(\x0e2\x18.grpc.pcbook.Memory.UnitR\x04unit\"^\n" +
	"\x04Unit\x12\v\n" +
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: grpc.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: grpc.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpc.pcbook.Memory.unit:type_name -> grpc.pcbook.Memory.Unit
