...
const file_screen_message_proto_rawDesc = "" +
	"\n" +
	"\x14screen_message.proto\x12\vgrpc.pcbook\"\x9b\x02\n" +
	"\x06Screen\x12\x1b\n" +
	"\tsize_inch\x18\x01 \x01(\x02R\bsizeInch\x12>\n" +
	"\n" +
	"resolution\x18\x02 \x01(\v2\x1e.grpc.pcbook.Screen.ResolutionR\n" +
	"resolution\x12/\n" +
	"\x05panel\x18\x03 \x01(\x0e2\x19.grpc.pcbook.Screen.PanelR\x05panel\x12\x1e\n" +
	"\n" +
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: grpc.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: grpc.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: grpc.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: grpc.pcbook.Screen.resolution:type_name -> grpc.pcbook.Screen.Resolution
	0, // 1: grpc.pcbook.Screen.panel:type_name -> grpc.pcbook.Screen.Panel
