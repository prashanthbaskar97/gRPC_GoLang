...
type Keyboard struct {
	...
	Layout        Keyboard_Layout        `protobuf:"varint,1,opt,name=layout,proto3,enum=grpc.pcbook.Keyboard_Layout" json:"layout,omitempty"`
...
const file_keyboard_message_proto_rawDesc = "" +
	"\n" +
	"\x16keyboard_message.proto\x12\vgrpc.pcbook\"\x95\x01\n" +
	"\bKeyboard\x124\n" +
	"\x06layout\x18\x01 \x01(\x0e2\x1c.grpc.pcbook.Keyboard.LayoutR\x06layout\x12\x18\n" +
	"\abacklit\x18\x02 \x01(\bR\abacklit\"9\n" +
	"\x06Layout\x12\v\n" +
	"\aUNKWOWN\x10\x00\x12\n" +
	"\n" +
...
var file_keyboard_message_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: grpc.pcbook.Keyboard.Layout
	(*Keyboard)(nil),     // 1: grpc.pcbook.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: grpc.pcbook.Keyboard.layout:type_name -> grpc.pcbook.Keyboard.Layout
