...
const file_laptop_service_proto_rawDesc = "" +
	"\n" +
	"\x14laptop_service.proto\x12\vgrpc.pcbook\x1a\x14laptop_message.proto\"B\n" +
	"\x13CreateLaptopRequest\x12+\n" +
	"\x06laptop\x18\x01 \x01(\v2\x13.grpc.pcbook.LaptopR\x06laptop\"&\n" +
	"\x14CreateLaptopResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id2f\n" +
	"\rLaptopService\x12U\n" +
	"\fCreateLaptop\x12 .grpc.pcbook.CreateLaptopRequest\x1a!.grpc.pcbook.CreateLaptopResponse\"\x00B:\n" +
...
var file_laptop_service_proto_goTypes = []any{
	(*CreateLaptopRequest)(nil),  // 0: grpc.pcbook.CreateLaptopRequest
	(*CreateLaptopResponse)(nil), // 1: grpc.pcbook.CreateLaptopResponse
	(*Laptop)(nil),               // 2: grpc.pcbook.Laptop
}
var file_laptop_service_proto_depIdxs = []int32{
	2, // 0: grpc.pcbook.CreateLaptopRequest.laptop:type_name -> grpc.pcbook.Laptop
	0, // 1: grpc.pcbook.LaptopService.CreateLaptop:input_type -> grpc.pcbook.CreateLaptopRequest
	1, // 2: grpc.pcbook.LaptopService.CreateLaptop:output_type -> grpc.pcbook.CreateLaptopResponse
